...
payload = {'emu1': '', 'ev1_supply': '', 'ev1_waste': '', 'emu1_O2': '', 'emu2': '', 'ev2_supply': '', 'ev2_waste': '', 'emu2_O2': '', 'O2_vent': '', 'depress_pump': ''}
...
#except KeyboardInterrupt:
        #print ("user interruption") # interrupted using keyboard "CTRL" + "C"
        #GPIO.cleanup()
except:
        GPIO.cleanup()
        print("other error")
